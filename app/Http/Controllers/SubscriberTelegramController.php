...
class SubscriberTelegramController extends Controller
{
    public function createView()
    {
        $data['page_title'] = "Create New Telegram Command";
        return view('telegram.subscriber-create',$data);
    }
    ...
    public function getTelegramCommands()
    {
        ...
        return view('telegram.subscriber-commands',$data);
    }
    public function editView($id)
    {
        $data['page_title'] = "Edit Telegram Command";
        $data['command'] = TelegramCommand::findOrFail($id);
        return view('telegram.subscriber-edit',$data);
    }
    ...
    public function createSpamView()
    {
        ...
        return view('telegram.subscriber-spam-create',$data);
    }
