...
class SubSignalController extends Controller
{
    use CommonTrait;
    ...
    public function create()
    {
        ...
        return view('signal.sub-create',$data);
    }
    ...
    public function index()
    {
        ...
        return view('signal.sub-index',$data);
    }
    public function show($id)
    {
       $data['page_title'] = "Ver Señal";
        ...
        return view('signal.sub-view',$data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('signal.sub-edit',$data);
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($sig->publish_status == 0) {
            ...
            session()->flash('message', 'Signal Update Successfully.');
            Session::flash('type', 'success');
            return redirect()->route('sub-signal-update', ['id', $request->signal_id]);
        }
    }
    ...
    public function destroy(Request $request)
    {
        ...
        return redirect()->route('sub-signal-all');
    }
}
