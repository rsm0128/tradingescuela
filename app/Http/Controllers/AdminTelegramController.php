...
class AdminTelegramController extends Controller
{
    public function createView()
    {
        ...
        return view('telegram.admin-create',$data);
    }
    ...
    public function createSpamView()
    {
        ...
        return view('telegram.admin-spam-create',$data);
    }
