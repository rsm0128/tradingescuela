    ...
    <div class="page-body">
        <div class="row">
            <div class="col-sm-12">
                ...
                <a style="font-size:1em; margin:auto; margin-bottom:1em;" class="btn btn-primary btn-sm bold uppercase block_button" href="https://signals.club/subadmin/add-material">Añadir Material</a>
                <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100" style="position:inline-block;">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('sub-edit-material', $m->id) }}" class="btn btn-primary btn-sm bold uppercase" title="Edit"><i class="fa fa-edit"></i> Editar</a></td>
                                </div>
                            </div>
                        </div>
                    @endforeach
                </div>
                <a style="font-size:1em; margin:auto; margin-bottom:1em;" class="btn btn-primary btn-sm bold uppercase block_button" href="https://signals.club/subadmin/add-mmaterial">Añadir Monthly Material</a>
                <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100" style="position:inline-block;">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('sub-edit-mmaterial', $m->id) }}" class="btn btn-primary btn-sm bold uppercase" title="Edit"><i class="fa fa-edit"></i> Editar</a></td>
                                </div>
                            </div>
                        </div>
                    @endforeach
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" >
                ...
                <div class="modal-body">
                    <strong>多Est叩 seguro que quiere borrar este material?</strong>
                </div>
                <div class="modal-footer">
                    <form method="post" action="{{ route('sub-material-delete') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}
