            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                            <form class="form form-horizontal" action="{{ route('user-update-profile') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">

                                    <div class="form-group row">
                                        <label class="col-md-3 label-control text-right" for="projectinput1"><b>Nombre de usuario : </b></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control text-right" for="projectinput2"><b>Correo electrónico : </b></label>
                                        <div class="col-md-8">
                                            <input type="email" id="projectinput2" readonly class="form-control" value="{{ $admin->email }}" placeholder="Email" name="email" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control text-right" for="projectinput1"><b>Teléfono : </b></label>
                                        <div class="col-md-2">
                                            <select name="country_code" id="country_code" required class="form-control font-weight-bold">
                                                <option selected="selected">{{$admin->country_code}}</option>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control text-right" for="projectinput2"><b>Imagen de Usuario : </b></label>
                                        <div class="col-md-8">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <span class="btn btn-info btn-file">
                                                    <span class="fileinput-new bold uppercase"><i class="fa fa-file-image-o"></i> Seleccionar imagen</span>
                                                    <span class="fileinput-exists bold uppercase"><i class="fa fa-edit"></i> Cambiar</span>
                                                    <input type="file" name="image" accept="image/*">
                                                </span>
                                                    <a href="#" class="btn btn-danger fileinput-exists bold uppercase" data-dismiss="fileinput"><i class="fa fa-trash"></i> Quitar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
