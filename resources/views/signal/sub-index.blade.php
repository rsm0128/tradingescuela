                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($signal as $k => $p)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('sub-signal-view',$p->id) }}" class="btn btn-primary btn-sm bold uppercase" title="Edit"><i class="fa fa-eye"></i> View</a>
                                            <a href="{{ route('sub-signal-edit',$p->id) }}" class="btn btn-warning btn-sm bold uppercase" title="Edit"><i class="fa fa-edit"></i> Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" >
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('sub-signal-delete') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}
