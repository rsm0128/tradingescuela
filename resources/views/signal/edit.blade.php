            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                            ...
                            <form class="form-horizontal" method="post" action="{{route('signal-update')}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <!--<div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea name="telegram" rows="5" class="form-control input-lg" required placeholder="Telegram Signal Description">{{ $signal->telegram }}</textarea>
                                                </div>
                                            </div>-->
