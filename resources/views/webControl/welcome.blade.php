                            ...
                            <form class="form-horizontal" method="post" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12"><strong style="text-transform: uppercase;">Welcome Page</strong></label>
                                        <div class="col-md-12">
                                            <textarea id="area1" class="form-control" rows="15" name="welcome">{{ $basic->welcome }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
