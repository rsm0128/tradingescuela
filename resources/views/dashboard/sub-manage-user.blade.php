            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div id="table-div" class="card-block">
                        @include('dashboard.sub-table-users')
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="ConModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" >
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('sub-user-delete') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#search-btn').on('click', function() {
                ...
                if(input !== '')
                    window.location.href =  "https://signals.club/subadmin/manage-user-email" + "/" + input;
            });
        });
