            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                            ...
                            <form class="form form-horizontal" action="{{ route('subscriber-update-profile') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">

                                    <div class="form-group row">
                                        <label class="col-md-2 label-control text-right font-weight-bold" for="projectinput1">SubAdmin Name : </label>
                                        <div class="col-md-8">
                                            <input type="text" id="projectinput1" class="form-control" value="{{ $admin->name }}" placeholder="Name" name="name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 label-control text-right font-weight-bold" for="projectinput2">SubAdmin User name : </label>
                                        <div class="col-md-8">
                                            <input type="text" id="projectinput2" class="form-control" value="{{ $admin->username }}" placeholder="User Name" name="username" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 label-control text-right font-weight-bold" for="projectinput2">SubAdmin Email : </label>
                                        <div class="col-md-8">
                                            <input type="email" id="projectinput2" class="form-control" value="{{ $admin->email }}" placeholder="Email" name="email" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 label-control text-right font-weight-bold" for="projectinput2">SubAdmin Picture : </label>
                                        <div class="col-md-8">
