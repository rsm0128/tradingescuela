                        ...
                        <form class="form form-horizontal" action="{{ route('user-update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="level" id="" class="form-control font-weight-bold">
                                            <option value="Principiante" class="font-weight-bold" @if($user->level == 'Principiante') selected @endif>Principiante</option>
                                            <option value="Intermedio" class="font-weight-bold" @if($user->level == 'Intermedio') selected @endif>Intermedio</option>
                                            <option value="Avanzado" class="font-weight-bold" @if($user->level == 'Avanzado') selected @endif>Avanzado</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 label-control text-right" for="projectinput1"><b>Register Code : </b></label>
                                    <div class="col-md-8">
                                        <select name="reg_code" id="reg_code" class="form-control font-weight-bold">
                                            <option value="">Select code</option>
                                            @foreach($codes as $code)
                                                <option value="{{$code['value']}}" @if($user->code == $code->value) selected @endif>{{ $code['value'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="discord_username" id="discord_username" class="form-control font-weight-bold" value="{{ $user->discord_username }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control text-right" for="discord_id"><b> Discord ID: </b></label>
                                    <div class="col-md-8">
                                        <input type="text" name="discord_id" id="discord_id" class="form-control font-weight-bold" value="{{ $user->discord_id }}">
                                    </div>
                                </div>
