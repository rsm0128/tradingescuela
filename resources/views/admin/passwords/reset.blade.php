        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="login-card card-block auth-body mr-auto ml-auto">
                    <form class="md-float-material" action="{{ route('admin.password.request') }}" method="post">
                        {!! csrf_field() !!}
                        ...
                        <div class="auth-box">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center txt-primary">Password Reset Here</h3>
                                </div>
                            </div>
                            <hr />
                            ...
                            <div class="row m-t-25">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Reset Now..!</button>
                                </div>
                            </div>
                        </div>
                    </form>
