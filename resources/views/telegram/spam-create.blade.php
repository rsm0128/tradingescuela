            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        {!! Form::open(['url' => '/subadmin/telegram-spam-create', 'method'=>'post', 'role'=>'form', 'class'=>'form-horizontal']) !!}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-10 offset-1">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="keyword" class="form-control input-lg" placeholder=" Key word" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
