            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        {!! Form::open(['url' => '/subadmin/telegram-command-create', 'method'=>'post', 'role'=>'form', 'class'=>'form-horizontal']) !!}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-10 offset-1">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="name" class="form-control input-lg" placeholder=" Name" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12"><strong>Message</strong></label>
                                            <div class="col-md-12">
                                                <textarea name="message" id="area1" rows="6" class="form-control" required placeholder="Message"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12"><strong>Description</strong></label>
                                            <div class="col-md-12">
                                                <textarea name="description" id="area1" rows="6" class="form-control" placeholder="Description"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
