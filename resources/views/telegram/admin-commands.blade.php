                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                @foreach($commands as $command)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin-telegram-command-edit', $command->id) }}" class="btn btn-warning btn-sm bold" title="Edit"><i class="fa fa-edit"></i> Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" >
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('admin-telegram-command-delete') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}
