            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        {!! Form::open(['url' => '/subadmin/telegram-command-edit', 'method'=>'post', 'role'=>'form', 'class'=>'form-horizontal']) !!}
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="command_id" value="{{$command->id}}">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="name" class="form-control input-lg" placeholder=" Name" value="{{$command->name}}" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12"><strong>Message</strong></label>
                                            <div class="col-md-12">
                                                <textarea name="message" rows="6" class="form-control" required placeholder="Message">{{$command->message}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12"><strong>Description</strong></label>
                                            <div class="col-md-12">
                                                <textarea name="description" rows="6" class="form-control" value="{{$command->description}}" placeholder="Description"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
